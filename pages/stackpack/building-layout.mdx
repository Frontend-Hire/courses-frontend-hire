...
```tsx filename="src/App.tsx" showLineNumbers {1-23}
...
![Broken output](./assets/2-building-layout-1.png)

Let us fix it.

```tsx filename="src/App.tsx" showLineNumbers {5, 10, 14, 20, 23}
import { Panel, PanelGroup, PanelResizeHandle } from 'react-resizable-panels';
...
![Better layout](./assets/2-building-layout-2.png)

Our resize works, but the handles are not visually evident. Let us fix that.

```tsx filename="src/App.tsx" showLineNumbers {12, 18}
import { Panel, PanelGroup, PanelResizeHandle } from 'react-resizable-panels';
...
```tsx filename="src/App.tsx" showLineNumbers {10, 14, 20}
import { Panel, PanelGroup, PanelResizeHandle } from 'react-resizable-panels';
...
![Full page layout](./assets/2-building-layout-3.png)
