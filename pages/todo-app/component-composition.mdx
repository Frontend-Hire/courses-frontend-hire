...
At this point your code should be a good match to the branch of the repository: [8-component-composition](https://github.com/yaralahruthik/todo-app/tree/8-component-composition)