...
<Callout>
The `key` prop is required when rendering a list of items. It helps React keep track of which items have changed, are added, or are removed. Read more about rendering lists and keys [here](https://react.dev/learn/rendering-lists).
</Callout>
...
![Expected output](./screenshots/reading-tasks-1.png)
...
At this point your code should be a good match to the branch of the repository: [2-reading-tasks](https://github.com/yaralahruthik/todo-app/tree/2-reading-tasks)