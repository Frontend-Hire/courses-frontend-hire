...
<Callout>
  We want to mention that this is not a huge performance problem. But it's a good example to show how we can improve the performance of our app without fancy tools like useCallback, useMemo, etc. In fact, in this case even those tools won't help us much.
</Callout>
