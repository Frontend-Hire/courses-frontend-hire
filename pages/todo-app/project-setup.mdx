...
<Callout>
Note the version of husky above `husky@8.0.3`. 

This is because in the live session Husky did not work because of a new version that is a breaking change `9.0.0`. 

Though we were able to solve it. We will be updating the instructions soon to use latest version of Husky
</Callout>
...
At this point your code should be a good match to the branch of the repository: [1-project-setup](https://github.com/yaralahruthik/todo-app/tree/1-project-setup)
